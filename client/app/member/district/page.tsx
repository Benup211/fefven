...
import useUserDistrictStore from "@/state/user/district-store";
import {
...
export default function DistrictMembers() {
    ...
    const filteredMembers = members.filter(
        (member) =>
            (selectedDistrict ? member.district === selectedDistrict : true) &&
            (searchTerm === "" ||
    ...
    const handleDistrictChange = (district: string) => {
        setSelectedDistrict(district === "all" ? undefined : district);
        setSearchTerm("");
        setCurrentPage(1);
    };
    ...
    return (
        <div className="container mx-auto py-8 px-4">
            ...
            {language==='en'?"District Executive Committee":"जिल्ला कार्य समिति"}
            </h1>
