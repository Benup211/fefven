...
import { Search, Phone, Grid, List } from "lucide-react";
import { motion } from "framer-motion";
import useUserAdvisoryStore from "@/state/user/advisory-store";
import {
...
export default function AdvisoryMembers() {
    ...
    const { members, error, fetchMembers } = useUserAdvisoryStore();
    ...
    return (
        <div className="container mx-auto py-8 px-4">
            <h1 className="text-4xl font-bold mb-8 text-center text-primary">
                {language === 'en' ? "Advisory Committee" : "सल्लाहकार समिति"}
            </h1>
